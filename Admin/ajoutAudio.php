...
<html>
	...
	<body>
		...
		<h1>Ajout d'un document Audio</h1>
		
		<form method="POST" action="actionAjAudio.php">
			<span>Titre : <input type="text" name="title"/></span><br/><br/>
			<span>Interprète : <input type="text" name="inter"/></span><br/><br/>
			<span>Compositeur : <input type="text" name="compo"/></span><br/><br/>
