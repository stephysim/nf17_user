...
<html>
	...
	<body>
		...
		<h1>Ajout d'un document Video</h1>
		
		<form method="POST" action="actionAjVideo.php">
			<span>Titre : <input type="text" name="title"/></span><br/><br/>
			<span>Acteur : <input type="text" name="act"/></span><br/><br/>
			<span>Réalisateur : <input type="text" name="real"/></span><br/><br/>
